...
plot '< ../ratio.py --sort --delim , --num 14 --den 10 < ../cost/azurefunctions-accesses-2020-sorted.csv-cost.dat' u 1:(1) smooth cnorm title "Num invocations", '< ../ratio.py --sort --delim , --num 16 --den 9 < ../cost/azurefunctions-accesses-2020-sorted.csv-cost.dat' u 1:(1) smooth cnorm title "Duration"
#    EOF
